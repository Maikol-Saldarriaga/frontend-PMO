...
export const ENDPOINTS = {
  ...
  projects: {
    ...
    invoiceById:       (id: string, bid: string, iid: string) => `${API_URL}/projects/${id}/budget/${bid}/invoices/${iid}`,
    invoiceHeaders:    (id: string) => `${API_URL}/projects/${id}/invoice-headers`,
    invoiceHeaderById: (id: string, hid: string) => `${API_URL}/projects/${id}/invoice-headers/${hid}`,
    invoiceHeaderDocument: (id: string, hid: string) => `${API_URL}/projects/${id}/invoice-headers/${hid}/document`,
