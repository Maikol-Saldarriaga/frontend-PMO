...
export const ENDPOINTS = {
  ...
  projects: {
    ...
    snapshotDelivery:  (id: string, sid: string, snid: string) => `${API_URL}/projects/${id}/scopes/${sid}/snapshots/${snid}/delivery`,
    snapshotDeliveryVerifications: (id: string, sid: string, snid: string) => `${API_URL}/projects/${id}/scopes/${sid}/snapshots/${snid}/delivery/verifications`,
    snapshotDeliveryVerificationById: (id: string, sid: string, snid: string, vid: string) => `${API_URL}/projects/${id}/scopes/${sid}/snapshots/${snid}/delivery/verifications/${vid}`,
